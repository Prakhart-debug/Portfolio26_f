...
const About = () => {
	return (
		<div
			id='about'
			className='flex flex-col justify-center mt-32 md:mt-64 lg:mt-80' 
			// ↑ pushed further down (adjust values as needed)
		>
			<div className='flex flex-col-reverse items-center justify-center lg:flex-row-reverse'>
				<div className='flex flex-col items-center justify-center md:w-1/2'>
					<h2 className='mx-auto my-5 w-fit px-5 text-center text-6xl tracking-wider text-skin-accent sm:text-7xl lg:text-9xl'>
						Get to know me
					</h2>
					<Aboutbio />
				</div>
