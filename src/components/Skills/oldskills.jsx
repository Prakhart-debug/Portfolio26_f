...
const oldskills = () => {
  return (
		<div className='relative flex   items-center justify-center   md:h-full md:w-1/2 '>
			<h3 className='mt-10 w-1/2 text-center font text-5xl text-skin-accent lg:text-9xl '>
				Things im good at
			</h3>
			...
			<div className='absolute top-72 flex   h-16 w-16 flex-col items-center justify-center rounded-md border-b-2 border-bordermain  p-2 font-bitechalknormal text-lg text-skin-base md:text-2xl md:text-2xl lg:top-10 lg:h-24 lg:w-24'>
			...
			<div className='absolute bottom-72 flex h-16 w-16 flex-col items-center justify-center rounded-md border-b-2 border-bordermain  p-2 font-bitechalknormal text-lg text-skin-base md:text-2xl lg:bottom-10 lg:h-24 lg:w-24'>
				<img
					className='my-2 mx-auto w-5 lg:w-7'
					src={gitcircle}
					alt=''
		  ...
		  <div className='absolute left-0 flex h-16 w-16 flex-col items-center justify-start pt-20 rounded-md border-b-2 border-bordermain p-2 font-bitechalknormal text-lg text-skin-base md:text-2xl lg:h-24 lg:w-24'>
			  <img
